...
if (localStorage.getItem('splashShown') === 'true' && !isPageReloaded()) {
    // If splash screen has already been shown and this is not a reload, skip it
    intro.style.top = '-100vh'; // Immediately hide splash screen
    header.style.opacity = '1';  // Show header immediately
} else {
